...
if(digit1 == u_digit1 and digit2==u_digit2): 
    print("상금은 100만원입니다.")
elif(digit1 == u_digit1 or digit1 == u_digit2) :  
    print("상금은 50만원입니다.")
else: 
    print("상금은 없습니다.")
...
if dist <=r1-r2: 
    ...
    turtle.write("두번째 원이 첫번쨰 원과 겹치지 않습니다.0")
t.sceen.exitonclick()       #화면을 마우스로 클릭해야 종료되게 하는 부분
...
if dist <=r1-r2: 
    ...
    write("두번째 원이 첫번쨰 원과 겹치지 않습니다.0")
